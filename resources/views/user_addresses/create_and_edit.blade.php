...
@section('content')
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="{{ route('root') }}">首页</a> <span class="mx-2 mb-0">/</span> <a href="{{ route('user_addresses.index') }}">收货地址列表</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">{{ $address->id ? '修改': '新增' }}收货地址</strong></div>
            </div>
        </div>
    </div>
